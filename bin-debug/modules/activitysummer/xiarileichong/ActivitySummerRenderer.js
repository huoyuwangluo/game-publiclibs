...
var renderer;
(function (renderer) {
    var ActivitySummerRenderer = (function (_super) {
        __extends(ActivitySummerRenderer, _super);
        function ActivitySummerRenderer() {
            var _this = _super.call(this) || this;
            _this._rwards = [_this.reward0, _this.reward1, _this.reward2];
            return _this;
        }
        ActivitySummerRenderer.prototype.dataChanged = function () {
            if (this.data) {
        ...
        ActivitySummerRenderer.prototype.showLeiJiDengLu = function (data) {
        ...
        ActivitySummerRenderer.prototype.showXiaRiLeiChong = function (data) {
            if (data.holidayRewardState == 2) {
        ...
        return ActivitySummerRenderer;
    }(ui.ActivitySummerRendererSkin));
    renderer.ActivitySummerRenderer = ActivitySummerRenderer;
    __reflect(ActivitySummerRenderer.prototype, "renderer.ActivitySummerRenderer");
})(renderer || (renderer = {}));
