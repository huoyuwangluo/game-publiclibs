...
var renderer;
(function (renderer) {
    var SummerXianGouLiBaoRenderer = (function (_super) {
        __extends(SummerXianGouLiBaoRenderer, _super);
        function SummerXianGouLiBaoRenderer() {
            var _this = _super.call(this) || this;
            _this._rwards = [_this.reward0, _this.reward1, _this.reward2];
            return _this;
        }
        SummerXianGouLiBaoRenderer.prototype.dataChanged = function () {
            if (this.data) {
                var data = this.data;
        ...
        return SummerXianGouLiBaoRenderer;
    }(ui.SummerXianGouLiBaoRendererSkin));
    renderer.SummerXianGouLiBaoRenderer = SummerXianGouLiBaoRenderer;
    __reflect(SummerXianGouLiBaoRenderer.prototype, "renderer.SummerXianGouLiBaoRenderer");
})(renderer || (renderer = {}));
