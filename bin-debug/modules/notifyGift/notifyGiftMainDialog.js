...
(function (dialog) {
    var gift;
    (function (gift) {
        var notifyGiftMainDialog = (function (_super) {
            __extends(notifyGiftMainDialog, _super);
            function notifyGiftMainDialog() {
                return _super.call(this) || this;
            }
            notifyGiftMainDialog.prototype.initialize = function () {
            ...
            notifyGiftMainDialog.prototype.enter = function (data) {
                var _this = this;
                GameModels.notifyGift.setNewGift1(false, 0);
            ...
            notifyGiftMainDialog.prototype.exit = function () {
            ...
            notifyGiftMainDialog.prototype.updateView = function (data) {
                this.clear();
                var openList = GameModels.notifyGift.getNotifyGiftVoArrByType(1);
                this._curtabs = [];
            ...
            notifyGiftMainDialog.prototype.updateRedState = function (index, value) {
                this._curtabs[index].imgRed.visible = value;
            };
            notifyGiftMainDialog.prototype.clear = function () {
                if (this._selected != -1) {
            ...
            notifyGiftMainDialog.prototype.onTabClick = function (e) {
                var index = this._curtabs.indexOf(e.target.parent);
                if (index != -1) {
                    this.onSelectChange(index);
                }
            };
            notifyGiftMainDialog.prototype.onSelectChange = function (index) {
                if (this._curstack.selectedChild)
                    this._curstack.selectedChild.exit();
            ...
            notifyGiftMainDialog.prototype.onLeftClick = function (e) {
            ...
            notifyGiftMainDialog.prototype.onRightClick = function (e) {
                this.tabGroup.validateNow();
            ...
            return notifyGiftMainDialog;
        }(ui.notifyGiftMainDialogSkin));
        gift.notifyGiftMainDialog = notifyGiftMainDialog;
        __reflect(notifyGiftMainDialog.prototype, "dialog.gift.notifyGiftMainDialog");
