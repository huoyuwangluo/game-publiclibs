...
var tips;
(function (tips) {
    var GetSpuerEquitmentTip = (function (_super) {
        __extends(GetSpuerEquitmentTip, _super);
        function GetSpuerEquitmentTip() {
            return _super.call(this) || this;
        }
        Object.defineProperty(GetSpuerEquitmentTip, "instance", {
            get: function () {
                if (!GetSpuerEquitmentTip._instance) {
                    GetSpuerEquitmentTip._instance = new GetSpuerEquitmentTip();
                    GetSpuerEquitmentTip._instance.touchEnabled = GetSpuerEquitmentTip._instance.touchChildren = false;
                }
                return GetSpuerEquitmentTip._instance;
            },
            enumerable: true,
            configurable: true
        });
        GetSpuerEquitmentTip.prototype.show = function (items, handler) {
            this._items = [];
            if (items.length > 3) {
                for (var i = 0; i < 3; i++) {
            ...
            this.y = mg.stageManager.stageHeight - 500;
        ...
        GetSpuerEquitmentTip.prototype.hide = function () {
            if (this._items) {
                var icon = void 0;
        ...
        GetSpuerEquitmentTip.prototype.flyOverHandler = function (icon) {
            if (icon.parent) {
        ...
        //根据长度显示多少个装备
        GetSpuerEquitmentTip.prototype.showIconPosition = function (num) {
            for (var i = 0; i < 3; i++) {
                if (i < num) {
        ...
        return GetSpuerEquitmentTip;
    }(ui.GetSpuerEquitmentSkin));
    tips.GetSpuerEquitmentTip = GetSpuerEquitmentTip;
    __reflect(GetSpuerEquitmentTip.prototype, "tips.GetSpuerEquitmentTip");
})(tips || (tips = {}));
