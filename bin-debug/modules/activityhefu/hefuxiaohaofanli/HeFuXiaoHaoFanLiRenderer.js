...
var renderer;
(function (renderer) {
    var HeFuXiaoHaoFanLiRenderer = (function (_super) {
        __extends(HeFuXiaoHaoFanLiRenderer, _super);
        function HeFuXiaoHaoFanLiRenderer() {
            var _this = _super.call(this) || this;
            _this._rwards = [_this.reward0, _this.reward1, _this.reward2];
            return _this;
        }
        HeFuXiaoHaoFanLiRenderer.prototype.dataChanged = function () {
            if (this.data) {
        ...
        return HeFuXiaoHaoFanLiRenderer;
    }(ui.HeFuXiaoHaoFanLiRendererSkin));
    renderer.HeFuXiaoHaoFanLiRenderer = HeFuXiaoHaoFanLiRenderer;
    __reflect(HeFuXiaoHaoFanLiRenderer.prototype, "renderer.HeFuXiaoHaoFanLiRenderer");
})(renderer || (renderer = {}));
