...
/**国战编辑界面 */
var kingWarMapBuZhen1 = (function (_super) {
    __extends(kingWarMapBuZhen1, _super);
    function kingWarMapBuZhen1() {
    ...
    Object.defineProperty(kingWarMapBuZhen1.prototype, "data", {
    ...
    kingWarMapBuZhen1.prototype.updataInfo = function () {
    ...
    kingWarMapBuZhen1.prototype.registerMoveItem = function () {
        var _this = this;
    ...
    kingWarMapBuZhen1.prototype.resetPetPosData = function () {
        var _this = this;
        this._petUid = [];
        for (var i = 0; i < this._headArr.length; i++) {
    ...
    kingWarMapBuZhen1.prototype.showView = function () {
    ...
    kingWarMapBuZhen1.prototype.onHeadClick = function (e) {
    ...
    kingWarMapBuZhen1.prototype.updataList = function () {
    ...
    kingWarMapBuZhen1.prototype.getState = function (uid) {
    ...
    kingWarMapBuZhen1.prototype.onListClick = function (e) {
    ...
    kingWarMapBuZhen1.prototype.onBtnClick = function (e) {
        var _this = this;
    ...
    kingWarMapBuZhen1.prototype.onClose = function (e) {
        mg.TipUpManager.instance.removeBlack();
        this.removeSelf();
    };
    kingWarMapBuZhen1.prototype.onTableClick = function (e) {
        this._currSelecdIndex = this._btnArr.indexOf(e.currentTarget);
        this.scroller.viewport.scrollV = 0;
        this.updataList();
        this.showBtnView();
    };
    kingWarMapBuZhen1.prototype.showBtnView = function () {
        for (var i = 0; i < this._btnArr.length; i++) {
    ...
    kingWarMapBuZhen1.prototype.removeSelf = function () {
    ...
    return kingWarMapBuZhen1;
}(ui.kingWarMapBuZhenSkin));
__reflect(kingWarMapBuZhen1.prototype, "kingWarMapBuZhen1", ["ITipLogic", "egret.DisplayObject"]);
