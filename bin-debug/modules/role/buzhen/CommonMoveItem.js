...
var common;
(function (common) {
    var CommonMoveItem = (function (_super) {
        __extends(CommonMoveItem, _super);
        function CommonMoveItem() {
            var _this = _super.call(this) || this;
            _this._dragIndex = -1; //dragHandler的回调参数
            _this._putIndex = -1; //putHandler的回调参数
            _this._collision_Range = 40 * 40; //碰撞范围的平方值,默认40*40
            return _this;
        }
        CommonMoveItem.prototype.initialize = function (data) {
        ...
        CommonMoveItem.prototype.reset = function () {
            this._source = null;
         ...
         */
        CommonMoveItem.prototype.register = function (caller, drags, dragHandler, puts, putHandler, clickHandler) {
        ...
        Object.defineProperty(CommonMoveItem.prototype, "collision_Range", {
            /**设置碰撞范围的平方值,默认40*40 */
            set: function (value) {
        ...
        Object.defineProperty(CommonMoveItem.prototype, "getSourceMethod", {
            set: function (method) {
                if (method) {
        ...
        CommonMoveItem.prototype._getSourceMethod = function (selectItem, dragIndex) {
            if (dragIndex === void 0) { dragIndex = -1; }
            if (selectItem)
                return selectItem;
            return null;
        };
        Object.defineProperty(CommonMoveItem.prototype, "source", {
            get: function () {
                return this._source;
            },
            set: function (data) {
                if (!data) {
                    ...
                    if (data instanceof vo.GamePetVO) {
                        this.imgQuality.source = ResPath.getPetQualityByStar(data.star, data.isHashFourSkill);
                        this.imgStar.source = "tujian_json.img_star" + data.star;
                        var item = Templates.getTemplateById(templates.Map.ITEM, data.refId);
                        this.imgHead.source = item.icon;
                        this.labName.text = data.name;
                        this.labName.textColor = TypeQuality.getStarColor(data.star);
                        this.labLv.text = "Lv." + data.lv;
                    }
                    else if (data instanceof vo.KingWarPetVO) {
                        this.imgQuality.source = ResPath.getPetQualityByStar(data.star, data.isHashFourSkill);
                        this.imgStar.source = "tujian_json.img_star" + data.star;
                        var item = Templates.getTemplateById(templates.Map.ITEM, data.petRefId);
                        this.imgHead.source = item.icon;
                        this.labName.text = data.template.name;
                        this.labName.textColor = TypeQuality.getStarColor(data.star);
                        ...
                        var star = 9;
                        var lv = 350;
                        if (GameModels.pet.isHashFourSkill(this._source)) {
                            star = 10;
                            lv = 400;
                        }
                        else {
                        ...
                        var temp = Templates.getTemplateById(templates.Map.GENERAL, this._source);
                        this.imgQuality.source = ResPath.getPetQualityByStar(star, GameModels.pet.isHashFourSkill(this._source));
                        this.imgStar.source = "tujian_json.img_star" + star;
                        var item = Templates.getTemplateById(templates.Map.ITEM, this._source);
                        this.imgHead.source = item.icon;
        ...
        CommonMoveItem.prototype.registerInfo = function (caller, drags, dragHandler, puts, putHandler, clickHandler) {
            if (dragHandler === void 0) { dragHandler = null; }
            if (putHandler === void 0) { putHandler = null; }
            if (clickHandler === void 0) { clickHandler = null; }
            this._caller = caller;
        ...
        CommonMoveItem.prototype.touchBeginHandler = function (e) {
            logger.log("开始点击。。。。。。。");
            this.clearData();
        ...
        CommonMoveItem.prototype.touchEndHandler = function (e) {
            logger.log("结束点击。。。。。。。");
        };
        CommonMoveItem.prototype.startmove = function (e) {
            logger.log("开始移动。。。。。。。");
            egret.Tween.removeTweens(this);
            var selectItem;
            if (this._drags instanceof eui.List) {
        ...
        CommonMoveItem.prototype.moveHandler = function (e) {
        ...
        CommonMoveItem.prototype.moveEndHandler = function (e) {
            var _this = this;
            ...
            if (this._putIndex >= 0) {
                //放置成功
                egret.Tween.get(this).to({ x: this._puts[this._putIndex].x, y: this._puts[this._putIndex].y }, 200, utils.Ease.cubicInOut).call(function () {
                    // this.source = null;
        ...
        //飞回原位置
        CommonMoveItem.prototype.tweenBack = function () {
            var _this = this;
            if (!this._isMove) {
                this.source = null;
                egret.Tween.removeTweens(this);
        ...
        CommonMoveItem.prototype.touchTestPointIndex = function () {
            var disArray = [];
        ...
        CommonMoveItem.prototype.clearData = function () {
            this._dragIndex = -1;
            this._putIndex = -1;
            this._isMove = false;
        };
        return CommonMoveItem;
    }(ui.CommonMoveItemSkin));
    common.CommonMoveItem = CommonMoveItem;
    __reflect(CommonMoveItem.prototype, "common.CommonMoveItem");
})(common || (common = {}));
