...
var renderer;
(function (renderer) {
    var meiRiLeiChongRenderer = (function (_super) {
        __extends(meiRiLeiChongRenderer, _super);
        function meiRiLeiChongRenderer() {
            var _this = _super.call(this) || this;
            _this._rwards = [_this.reward0, _this.reward1, _this.reward2, _this.reward3];
            return _this;
        }
        meiRiLeiChongRenderer.prototype.dataChanged = function () {
        ...
        return meiRiLeiChongRenderer;
    }(ui.meiRiLeiChongRendererSkin));
    renderer.meiRiLeiChongRenderer = meiRiLeiChongRenderer;
    __reflect(meiRiLeiChongRenderer.prototype, "renderer.meiRiLeiChongRenderer");
})(renderer || (renderer = {}));
